...
?>
<nav class="navbar navbar-expand-lg navbar-light bg-light mynavt">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
          <li class="nav-item">
            <a class="nav-link active" href="{{route('cartpage')}}">Cart <i class="fa fa-cart-arrow-down"></i>{{$totalss}}</a>
          </li>
          @if (Session::has('user'))
